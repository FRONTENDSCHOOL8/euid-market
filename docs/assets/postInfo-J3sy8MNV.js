import{i as e,g as i,c as n}from"./tiger-TocbYAJf.js";import{r as c}from"./renderTopBar-BHiepWVN.js";import{p}from"./pocketbase-zYAbJ1uT.js";async function l(o,t){const a=await p.collection("posts").getOne(t),r=`
  ...
  `;e(o,r)}const{localStorage:g}=window,f=g.curr_id,s=i(".board--post-info-container");n(s,c("withShare"));l(s,f);
