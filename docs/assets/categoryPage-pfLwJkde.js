import{t as n,i as r}from"./tiger-TocbYAJf.js";async function g(){(await n.get("http://127.0.0.1:8090/api/collections/interest_category/records")).data.items.forEach(e=>{const o=`
