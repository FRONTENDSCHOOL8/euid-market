...
`}function m(e){return`<li class="user--profile-content user--profile-badge">
...
`}function d(e){return`
  ...
  </li>`}function b(e){return` <label for="temperature"
  >열정온도
  <a href=""
...
<div class="user--profile-badge-detail is-active"><div>`;function $(e,i){return`
        <figure>
          <img src="${e}" />
          <figcaption><p>${i}</p></figcaption>
       </figure> 
    `}const h='<div class="user--profile-manner-wrapper "> </div>';function w(e,i){return`
      <div class="user--profile-manner-detail">
          <img src=${f} alt="" />
          <span>${e}</span><p>${i}</p> 
      </div>`}function _(e){let{id:i,user_nickname:s,user_year:a,user_photo:t}=e;return`
    <figure>
      <figcaption>
        <p>${s}</p>
        <span>${a}기</span>
      ...
      <img src="https://euid-marke.pockethost.io/api/files/users/${i}/${t}" alt="" />
    </figure>
  `}function y(e){let{id:i,user_photo:s,user_job:a,user_age:t,user_gender:p,user_nickname:l,user_organization:o,user_certification:u}=e;return`<div>
  <h2>기본 정보</h2>
...
</ul>`}function L(e){let{gender_is_public:i,age_is_public:s}=e;return`  <li>
<p>성별</p>
<span>정보 공개 시, 내 답변 프로필 카드에 정보가 노출됩니다.</span>
<div class="profile--modify-visibility profile--gender-is-public">
  <button type="button" class="profile--modify-private" data-is_private =${i} data-is_public = ${!i} >비공개</button>
  <button type="button" class="profile--modify-public " data-is_private =${!i} data-is_public = ${i}>전체공개</button>
</div>
</li>
<li>
<p>연령</p>
...
<div class="profile--modify-visibility">
  <button type="button"  class="profile--modify-private" data-is_public =${!s}>비공개</button>
  <button type="button"  class="profile--modify-public" data-is_public =${s}>전체공개</button>
</div>
</li>`}export{d as a,C as b,v as c,$ as d,w as e,y as f,_ as g,L as h,h as m,m as p,b as u};
