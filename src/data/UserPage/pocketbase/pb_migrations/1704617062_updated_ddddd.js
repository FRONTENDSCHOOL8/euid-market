...
migrate((db) => {
  ...
  collection.name = "user_badge_view"
  ...
  // remove
  collection.schema.removeField("fgpqi9qj")

  // remove
  collection.schema.removeField("avbhogml")

  // remove
  collection.schema.removeField("2lezrw6p")
